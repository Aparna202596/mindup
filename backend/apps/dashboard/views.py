...
def admin_dashboard(request):
    ...
    if tab == "topics":
        items = Topic.objects.select_related("created_by").order_by("-created_at")
    elif tab == "categories":
        items = Category.objects.select_related("topic", "created_by").order_by("-created_at")
    elif tab == "subcategories":
        items = SubCategory.objects.select_related(
        ...
        items = Answer.objects.select_related(
            "question", "created_by"
        ).order_by("-created_at")
    elif tab == "bulk_uploads":
        items = BulkUploadSession.objects.select_related(
